...
export const SinglePin4CapacitorsToGround: SmallPatternComponent = (
  ...
  return (
    <group>
      ...
      <capacitor
        name={`C${pin}_3`}
        capacitance="100nF"
        schX={pinPosition.x + 2.4 + slideVariations[0] * 0.2}
        schY={pinPosition.y - 1.2 + slideVariations[1] * 0.2}
        schRotation="-90deg"
        connections={{
          pin1: `U1.${pin}`,
      ...
      <capacitor
        name={`C${pin}_4`}
        capacitance="100nF"
        schX={pinPosition.x + 3.4 + slideVariations[0] * 0.2}
        schY={pinPosition.y - 1.2 + slideVariations[1] * 0.2}
        schRotation="-90deg"
        connections={{
          pin1: `U1.${pin}`,
...
SinglePin4CapacitorsToGround.usedSlideVariationDimensions = [0, 1]
SinglePin4CapacitorsToGround.getCode = (props: SmallPatternProps) => {
  const { pins, pinCount, slideVariations } = props
  const pin = pins[0]!
  const pinPosition = getPinPosition(pinCount - 1, pinCount)
