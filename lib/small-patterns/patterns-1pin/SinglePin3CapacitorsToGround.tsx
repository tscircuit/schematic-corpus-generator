...
export const SinglePin3CapacitorsToGround: SmallPatternComponent = (
...
SinglePin3CapacitorsToGround.usedSlideVariationDimensions = [0, 1]
SinglePin3CapacitorsToGround.getCode = (props: SmallPatternProps) => {
  const { pins, pinCount, slideVariations } = props
  const pin = pins[0]!
  const pinPosition = getPinPosition(pinCount - 1, pinCount)
