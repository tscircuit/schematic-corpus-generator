...
export const SinglePinResistorToPower: SmallPatternComponent = ({
  pins,
  pinCount,
  slideVariations,
}: SmallPatternProps) => {
...
SinglePinResistorToPower.usedSlideVariationDimensions = [0]
SinglePinResistorToPower.getCode = (props: SmallPatternProps) => {
  ...
  <resistor
    ...
    schY="${pinPosition.y + 1}"
    schRotation="90deg"
    connections={{pin1: "U1.${pin}", pin2: "net.VCC"}}
  />`
}
